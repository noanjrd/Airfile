  ...
  return (
    <>
      <div className="flex flex-col w-full h-full items-center justify-center bg-white border font-sans">
          {inputtype === "text" && (
          <div className="">
            <textarea className="w-full h-5 border-2 rounded-lg border-[#D4D4D4] bg-[#F4F4F4] text-black px-2 py-2" onChange={changeTextinput}></textarea>
          </div>
        )
        }
        
      </div>
        <div className="absolute opacity-0 -z-12">
