    ...
    return (
        <AnimatePresence>
            {isDisplayed && (<motion.div
                ...
                className=" fixed flex flex-col justify-center  bg-[#ffeaea] border-2 border-[#ff5555] w-65 lg:w-80 h-12 lg:h-15 z-50 bottom-2 lg:bottom-2  lg:right-2 rounded-lg ">
