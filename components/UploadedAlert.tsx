    ...
    return (
        <AnimatePresence>
            {isDisplayed && (<motion.div
                ...
                className=" fixed flex flex-col justify-center  bg-[#277DFF]/20 border-2 border-[#277DFF] w-65 lg:w-80 h-12 lg:h-15 z-50 bottom-4 lg:bottom-2  lg:right-2 rounded-lg ">
